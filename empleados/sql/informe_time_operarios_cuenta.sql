-- Function: informe_time_operarios(text, text)

-- DROP FUNCTION informe_time_operarios(text, text);

CREATE OR REPLACE FUNCTION informe_time_operarios_cuenta(
    f1 text,
    f2 text, id_cuenta integer)
  RETURNS json AS
$BODY$
		declare
		  tipos_servi json;
  ...
  COST 100;
ALTER FUNCTION informe_time_operarios_cuenta(text, text,integer)
  OWNER TO postgres;
