-- Function: report_empleados_comision(text, text)

-- DROP FUNCTION report_empleados_comision(text, text);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION report_empleados_comision_cuenta(text, text, integer)
  OWNER TO postgres;
