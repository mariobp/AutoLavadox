    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificacion', models.CharField(blank=True, max_length=20, null=True, validators=[django.core.validators.RegexValidator(re.compile('^([1-9]+[0-9]*){7,20}$'), 'No valida', 'invalid')])),
