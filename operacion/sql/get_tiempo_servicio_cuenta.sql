-- Function: get_tiempo_servicio(text, text)

-- DROP FUNCTION get_tiempo_servicio(text, text);

CREATE OR REPLACE FUNCTION get_tiempo_servicio_cuenta(
    d1 text,
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION get_tiempo_servicio_cuenta(text, text, integer)
  OWNER TO postgres;
