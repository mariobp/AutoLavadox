-- Function: public.report_empleados_comision(text, text)

-- DROP FUNCTION public.report_empleados_comision(text, text);

CREATE OR REPLACE FUNCTION public.report_empleados_comision(
    d1 text,
    d2 text)
  RETURNS json AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.report_empleados_comision(text, text)
  OWNER TO postgres;
