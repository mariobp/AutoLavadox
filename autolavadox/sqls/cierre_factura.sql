-- Function: public.cierre_factura(text, text)

-- DROP FUNCTION public.cierre_factura(text, text);

CREATE OR REPLACE FUNCTION public.cierre_factura(
    d1 text,
    d2 text)
  RETURNS json AS
$BODY$
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.cierre_factura(text, text)
  OWNER TO postgres;
