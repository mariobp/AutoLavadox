-- Function: public.cierre_factura_total(text, text)

-- DROP FUNCTION public.cierre_factura_total(text, text);

CREATE OR REPLACE FUNCTION public.cierre_factura_total(
    d1 text,
    d2 text)
  RETURNS json AS
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.cierre_factura_total(text, text)
  OWNER TO postgres;
