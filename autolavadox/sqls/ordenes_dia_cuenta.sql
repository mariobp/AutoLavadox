-- Function: public.ordenes_dia_cuenta(integer)

-- DROP FUNCTION public.ordenes_dia_cuenta(integer);

CREATE OR REPLACE FUNCTION public.ordenes_dia_cuenta(id_cuenta integer)
  RETURNS json AS
$BODY$
begin
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION public.ordenes_dia_cuenta(integer)
  OWNER TO postgres;
